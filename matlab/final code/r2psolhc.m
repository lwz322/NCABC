...
function r2psolhc(func_no, runs, bounds, optima, tolerance, Particle_Number, Max_Gen, t_dis)
    ...
    dlmwrite(strcat('r2psolhc_info', char(num2str(func_no)), '_', char(num2str(runs)), '.txt'), traceInfo, 'newline', 'pc');
    dlmwrite(strcat('r2psolhc_result', char(num2str(func_no)), '_', char(num2str(runs)), '.txt'), fresult, 'newline', 'pc');
    dlmwrite(strcat('r2psolhc_peak', char(num2str(func_no)), '_', char(num2str(runs)), '.txt'), finalpeak, 'newline', 'pc');
    clear all
