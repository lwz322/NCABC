...
class CEC2013(object):
    ...
    __nopt_ = [2, 5, 1, 4, 2, 18, 36, 81,
               216, 12, 6, 8, 6, 6, 8, 6, 8, 6, 8, 8]
    ...
    __dimensions_ = [1, 1, 1, 2, 2, 2, 2, 3,
                     3, 2, 2, 2, 2, 3, 3, 5, 5, 10, 10, 20]
    __popsize_ = [80, 80, 80, 80, 80, 100, 300, 300,300, 100, 
    ...
    def get_popsize(self):
        return self.__popsize_[self.__nfunc_-1]
